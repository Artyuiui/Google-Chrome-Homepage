...
4. ตรวจว่า `index.html`, `enhancements.css` และ `enhancements.js` อยู่ในโฟลเดอร์เดียวกัน ห้ามดาวน์โหลดเฉพาะ `index.html`
...
2. นำ `index.html`, `enhancements.css` และ `enhancements.js` ใหม่ไปแทนไฟล์เดิมในโฟลเดอร์เดิม
